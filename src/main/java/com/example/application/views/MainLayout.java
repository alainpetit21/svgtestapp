...
import com.example.application.views.svgtest.SVGTestView;
...
public class MainLayout extends AppLayout {
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/logo.png", "SVGTestApp logo"));
        logoLayout.add(new H1("SVGTestApp"));
    ...
    private List<Tab> createMenuItems() {
        MenuItemInfo[] menuItems = new MenuItemInfo[]{ //
                new MenuItemInfo("SVGTest", "lab la-500px", SVGTestView.class), //
